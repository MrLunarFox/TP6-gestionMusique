 ...
 */
class getMorceauRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\MorceauRepository' shared autowired service.
     *
     * @return \App\Repository\MorceauRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'MorceauRepository.php';

        return $container->privates['App\\Repository\\MorceauRepository'] = new \App\Repository\MorceauRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
